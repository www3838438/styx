...
public class KubernetesDockerRunnerTest {
  ...
  V1Pod createdPod = KubernetesDockerRunner.createPod(WORKFLOW_INSTANCE, RUN_SPEC, EMPTY_SECRET_SPEC);
  ...
  public void setUp() throws Exception {
    ...
    kdr = new KubernetesDockerRunner(k8sClient, stateManager, stats, serviceAccountSecretManager, debug, NO_POLL,
                                     POD_DELETION_DELAY_SECONDS, CLOCK, "default");
    kdr.init();
